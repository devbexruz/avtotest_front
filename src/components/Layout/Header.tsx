        ...
        <div className="flex items-center space-x-4">
          ...
          {check_login ? (
            ...
            {/* Til tanlash dropdown */}
            {
              ...
              (
                <span>
                  <button
                    onClick={() => {c.toCyril();
                      window.location.reload();}}
                    className="cursor-pointer bg-neutral-700 hover:bg-neutral-500 m-1 px-3 py-1 rounded transition">
                    Ўзбекча
                  </button>
                  <button
                    onClick={() => {c.toUzbek();
              ...
              <span
                className="bg-neutral-700 px-3 py-1 rounded transition flex items-center gap-2">
              ...
              <button
                onClick={logOut}
                className="cursor-pointer bg-neutral-700 hover:bg-red-500 px-3 py-1 rounded transition">
                {c.t("Chiqish")}
              </button>
            </>
          ) : (
