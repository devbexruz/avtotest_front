            ...
            {usersStats.length === 0 ? (
              ...
              usersStats.map((stat) => (
                <tr key={stat.id} className="border-b border-neutral-200 hover:bg-neutral-50">
                  <td className="py-3 px-6 text-black whitespace-nowrap font-semibold">{stat.id}</td>
                  <td className="py-3 px-6 text-black font-medium">{stat.name}</td>
                  <td className="py-3 px-6 text-black font-medium">{stat.total_tests}</td>
                  <td className="py-3 px-6 text-black font-medium">{stat.total_correct}</td>
                  <td className="py-3 px-6 text-black font-medium">{stat.total_incorrect}</td>
                  <td className="py-3 px-6 text-black font-medium">{stat.total_questions}</td>
